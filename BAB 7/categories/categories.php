        ...
        <div class="item-list" id="commodity-list">
          <div class="item-list" id="commodity-list">
            ...
            if(mysqli_num_rows($result) == 0) {
                echo "<center><h3>Belum ada data komoditas</h3></center>";
            } else {
                while($data = mysqli_fetch_assoc($result)) {
            ?>
                <div class="item">
                    <div class="item-img">
                        <img src="../img_categories/<?php echo $data['photo']; ?>" alt="<?php echo $data['categories']; ?>">
                    </div>
                    <div class="item-details">
                        <h5><?php echo $data['categories']; ?></h5>
                        <p><?php echo $data['description']; ?></p>
                        <p class="price">Rp <?php echo number_format($data['price']); ?></p>
                    </div>
                    <div class="action-buttons">
                        <a href="categories-edit.php?id=<?php echo $data['id']; ?>" class="btn-edit" style="text-decoration:none; color:white;">
                            <i class='bx bxs-pencil'></i> Edit
                        </a>
                        <a href="categories-hapus.php?id=<?php echo $data['id']; ?>" class="btn-delete" style="text-decoration:none; color:white;" onclick="return confirm('Yakin hapus data ini?')">

    ...
    <header>
      <nav>
        ...
        <ul>
          ...
          <li><a href="login.php" class="btn_login active">Login</a></li>
        </ul>
      </nav>
    </header>
    <main>
      <div class="auth-wrapper">
        <div class="auth-container">
            <div class="auth-panel left-panel">
                ...
                <p>Silakan masuk untuk mengelola data pertanian Anda.</p>
            </div>
            <div class="auth-panel right-panel">
                <div class="form-container">
                    ...
                    <a href="register.php" class="link-register">Belum punya akun? Register disini</a>
                </div>
            </div>
        </div>
      </div>

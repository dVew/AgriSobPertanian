...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li><a href="../transaction/transaction.php"><i class="bx bx-list-ul"></i><span class="links_name">Transaction</span></a></li>
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="card">
        ...
        <form class="form-grid" action="categories-proses.php" method="POST">
